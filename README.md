...
# Foundry Fund Me
This is a project regarding funding to the smartcontract owner where he can only withdraw funds and the funder would only be able to fund for the owner.More gas optimisation techniques are followed for reducing the gas costs during transactions.
